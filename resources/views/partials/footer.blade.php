    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <p class="text-sm text-slate-600 font-serif leading-relaxed max-w-sm">
                ...
                <div class="pt-2 flex items-center gap-4 text-xs font-serif font-medium text-slate-500">
            ...
            <!-- Solutions -->
            <div>
                <h4 class="text-sm font-semibold text-slate-900 font-serif uppercase tracking-wider mb-4">Solutions</h4>
                <ul class="space-y-2.5 text-sm font-serif">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-sm font-semibold text-slate-900 font-serif uppercase tracking-wider mb-4">Company</h4>
                <ul class="space-y-2.5 text-sm font-serif">
            ...
            <!-- Contact Information -->
            <div>
                <h4 class="text-sm font-semibold text-slate-900 font-serif uppercase tracking-wider mb-4">Get In Touch</h4>
                <ul class="space-y-3 text-sm font-serif">
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+917868925566" class="hover:text-sky-600 transition-colors font-serif font-medium">+91 78689 25566</a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:info@tracktechsolutions.com" class="hover:text-sky-600 transition-colors font-serif">info@tracktechsolutions.com</a>
                    </li>
                </ul>
            </div>
        </div>

        <div class="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-serif text-slate-500">
