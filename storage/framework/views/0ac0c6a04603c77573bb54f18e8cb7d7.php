<header x-data="{ scrolled: false, productDropdown: false, mobileMenu: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 group">
            <img src="<?php echo e(asset('images/logo-icon.png')); ?>" alt="Track Tech Solution Logo" class="h-11 sm:h-12 w-auto object-contain group-hover:scale-105 transition-transform drop-shadow-sm">
        ...
        <nav class="hidden md:flex items-center gap-8 font-sans">
            ...
            <div class="relative" @mouseenter="productDropdown = true" @mouseleave="productDropdown = false">
                ...
                <div x-show="productDropdown" x-cloak x-transition
                    ...
                    <div class="flex flex-col gap-1">
                        <a href="<?php echo e(route('products.quality-control')); ?>" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-sky-50 transition-colors group">
                        ...
                        <a href="<?php echo e(route('products.production-tracking')); ?>" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-sky-50 transition-colors group">
                            <div class="p-2 rounded-lg bg-sky-100 text-sky-600 group-hover:bg-sky-500 group-hover:text-white transition-colors">
                        ...
                        <a href="<?php echo e(route('products.machine-maintenance')); ?>" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-sky-50 transition-colors group">
                            <div class="p-2 rounded-lg bg-sky-100 text-sky-600 group-hover:bg-sky-500 group-hover:text-white transition-colors">
                        ...
                        <a href="<?php echo e(route('products.production-planning')); ?>" class="flex items-start gap-3 p-2.5 rounded-xl hover:bg-sky-50 transition-colors group">
                            <div class="p-2 rounded-lg bg-sky-100 text-sky-600 group-hover:bg-sky-500 group-hover:text-white transition-colors">
            ...
            <a href="<?php echo e(route('home')); ?>#impact" class="text-sm font-medium text-slate-700 hover:text-sky-600 transition-colors">
                Impact & Metrics
            </a>
            ...
            <a href="<?php echo e(route('contact')); ?>" class="text-sm font-medium text-slate-700 hover:text-sky-600 transition-colors">
                Contact Us
            </a>
        </nav>
    ...
    <div x-show="mobileMenu" x-cloak class="md:hidden bg-white/95 border-b border-slate-200 px-4 pt-3 pb-6 flex flex-col gap-4 font-sans">
        <a href="<?php echo e(route('products.quality-control')); ?>" class="text-sm font-medium text-slate-700">Quality Control AI</a>
