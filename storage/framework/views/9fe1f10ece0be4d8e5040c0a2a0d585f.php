...
<?php $__env->startSection('title', 'Contact Us - Track Tech Solution'); ?>
...
<div class="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-7 p-8 rounded-3xl bg-white border border-sky-200 shadow-xl space-y-6" x-data="{ submitted: false, loading: false }">
            ...
            <template x-if="!submitted">
                <form action="<?php echo e(route('demo.store')); ?>" method="POST" class="space-y-4 font-sans" @submit.prevent="
                    loading = true;
                    fetch('<?php echo e(route('demo.store')); ?>', {
                        method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sweth\OneDrive\Desktop\Trach_Tech_Solution\main_page\resources\views/contact.blade.php ENDPATH**/ ?>