<footer class="relative bg-white border-t border-slate-200 text-slate-600 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div class="lg:col-span-2 space-y-4">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
                    <img src="<?php echo e(asset('images/logo-icon.png')); ?>" alt="Track Tech Solution Logo" class="h-11 sm:h-12 w-auto object-contain drop-shadow-sm">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm font-sans">
                    <li><a href="<?php echo e(route('products.quality-control')); ?>" class="hover:text-sky-600 transition-colors">Quality Control AI</a></li>
                    <li><a href="<?php echo e(route('products.production-tracking')); ?>" class="hover:text-sky-600 transition-colors">Production Tracking</a></li>
                    <li><a href="<?php echo e(route('products.machine-maintenance')); ?>" class="hover:text-sky-600 transition-colors">Machine Maintenance (OEE)</a></li>
                    <li><a href="<?php echo e(route('products.production-planning')); ?>" class="hover:text-sky-600 transition-colors">Production Planning</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm font-sans">
                    <li><a href="<?php echo e(route('home')); ?>#impact" class="hover:text-sky-600 transition-colors">Our Impact</a></li>
                    <li><a href="<?php echo e(route('home')); ?>#interactive-3d" class="hover:text-sky-600 transition-colors">3D Viewport</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-sky-600 transition-colors">Contact Support</a></li>
        ...
        <div class="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-sans text-slate-500">
            <div>© <?php echo e(date('Y')); ?> Track Tech Solution. All rights reserved.</div>
...
<?php /**PATH C:\Users\sweth\OneDrive\Desktop\Trach_Tech_Solution\main_page\resources\views/partials/footer.blade.php ENDPATH**/ ?>