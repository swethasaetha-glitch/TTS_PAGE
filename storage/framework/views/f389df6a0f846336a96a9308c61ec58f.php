<?php $__env->startSection('title', 'Production Tracking System (PTS) - Track Tech Solution'); ?>

<?php $__env->startSection('content'); ?>
<div class="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-sky-600 hover:text-sky-700">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sweth\OneDrive\Desktop\Trach_Tech_Solution\main_page\resources\views/products/production-tracking.blade.php ENDPATH**/ ?>