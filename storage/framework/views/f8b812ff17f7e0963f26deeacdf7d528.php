<div x-show="quoteModalOpen" x-cloak
     ...
     x-data="{
        ...
        submitQuote() {
            this.loading = true;
            fetch('<?php echo e(route('quote.store')); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\Users\sweth\OneDrive\Desktop\Trach_Tech_Solution\main_page\resources\views/partials/quote-modal.blade.php ENDPATH**/ ?>